...
<body>
	<div class="container-fluid">
		<div class="row">
			...
			<nav class="col-md-2 sidebar d-flex flex-column">
				...
				<a href="/register-patient"><i class="bi bi-person-plus me-2"></i>Register
					Patient</a> <a href="/view-patients" class="active"><i
					class="bi bi-people-fill me-2"></i>View Patients</a> <a
					href="/lab-reports"><i class="bi bi-flask me-2"></i>Lab Reports</a>
				<a href="/refer-cases"><i class="bi bi-arrow-repeat me-2"></i>Refer
					Cases</a> <a href="/history"><i class="bi bi-clock-history me-2"></i>History</a>
				<a href="/logout" class="mt-auto"><i
				...
				<div class="d-flex justify-content-between align-items-center mb-4">
					...
					<div>
						<input type="text" class="form-control d-inline-block"
							placeholder="Search Patient..." style="width: 250px;">
					</div>
				</div>
								...
								<table class="table table-hover align-middle">
									...
									<tbody>
										<c:forEach var="p" items="${patients}" varStatus="loop">
											...
											<tr
												onclick="updateProfile('${p.name}', '${p.doctor}', '${p.phone}', '${p.address}', '${p.visitTime}', '${p.id}', '${p.gender}', '${p.caseType}', '${p.dob}', '${p.aadharId}', '${p.imageUrl}')">
												<td>${loop.index + 1}</td>
												<td>${p.visitTime}</td>
												<td>${p.name}</td>
												<td>${p.department}</td>
					...
					<div class="col-md-4">
						<div class="card-box text-center p-4">
							...
							<div class="mx-auto rounded-circle overflow-hidden mb-3"
								...
								<img id="patientImg" src="/images/default-avatar.png"
							...
							<div class="text-start">
								<p>
									<strong>Aadhar ID:</strong> <span id="aadharId">—</span>
								</p>
								<p>
									<strong>Patient ID:</strong> <span id="patientId">—</span>
								</p>
								<p>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content p-4">
				<div class="modal-header">
					<h5 class="modal-title" id="recordModalLabel">Medical History</h5>
				...
				<div class="modal-body">
					...
					<p>
						<strong>Prescription:</strong> Paracetamol, Rest, Fluids
					</p>
					<p>
						<strong>Notes:</strong> Patient advised rest for 5 days, follow-up
						required.
					</p>
				</div>
			</div>
	...
	<script>
		function updateProfile(name, doctor, phone, address, visitTime,
			...
			document.getElementById("doctorName").innerText = "Admitted by: Dr. "
					+ doctor;
			document.getElementById("phone").innerText = phone;
			document.getElementById("address").innerText = address;
			document.getElementById("patientId").innerText = "RM"
					+ (100000 + parseInt(patientId));
			document.getElementById("dob").innerText = dob && dob !== 'null' ? dob : '—';
			document.getElementById("aadharId").innerText = aadharId || '—';
			document.getElementById("patientImg").src = imageUrl
